...
class RepositoryImpl : Repository {
    ...
    override fun getRemoteData(weather: Weather?, listener: Repository.WeatherLoadListener): Weather {
        if (weather != null) {
        val loader = WeatherLoader(listener, weather.city.lat,weather.city.lon)
        loader.loadWeather()
            return weather
        } else return Weather()
    }
